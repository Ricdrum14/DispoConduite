...
export function StatusHero({ active, onToggle }: StatusHeroProps) {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-foreground p-6 text-background shadow-2xl shadow-foreground/10 sm:p-8">
      ...
      <div className="absolute right-24 top-8 hidden h-28 w-28 rounded-full border-[14px] border-primary/20 sm:block" />
      <div className="absolute right-4 bottom-4 hidden h-20 w-20 rounded-full bg-primary/15 sm:block" />
